...
function Outro.draw()
  if positive then
    ...
    love.graphics.print("Tap to play again", love.graphics.getWidth()/2-45, love.graphics.getHeight()/2+5)
  else
    love.graphics.setColor(0.3,0.3,0.3, 0.4)
    love.graphics.rectangle("fill", love.graphics.getWidth()/2-75,
          love.graphics.getHeight()/2-45, 150, 90)
    ...
    love.graphics.print("Tap to try again", love.graphics.getWidth()/2-45, love.graphics.getHeight()/2 + 5)
  end
end
